...
main() {
  group('Balance Payment Ratio', () {
    test('Sort order', () {
      ...
      List<Debt> debts = [
        new Debt('Test1', 1500.0, .11, 40.0),
        new Debt('Test4', 500.0, .12, 40.0),
        new Debt('Test3', 3500.0, .13, 40.0),
        new Debt('Test2', 2500.0, .14, 40.0),
      ];
  ...
  group('Balance Rate Ratio', () {
    test('Sort order', () {
      ...
      List<Debt> debts = [
        new Debt('Test1', 1500.0, .1, 40.0),
        new Debt('Test4', 500.0, .1, 40.0),
        new Debt('Test3', 3500.0, .1, 40.0),
        new Debt('Test2', 2500.0, .1, 40.0),
      ];
      List<Debt> sorted = repayment.sort(debts);
